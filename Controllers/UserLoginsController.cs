...
namespace WebModuleApp.Controllers
{
    public class UserLoginsController : Controller
    {
        ...
        {
            var userLogins = db.UserLogins.Include(u => u.User);
        ...
        public ActionResult Create([Bind(Include = "LoginId,UserId")] UserLogin userLogin)
        {
            ...
            ViewBag.UserId = new SelectList(db.Users, "UserId", "Username", userLogin.UserId);
            return View(userLogin);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LoginId,UserId")] UserLogin userLogin)
        {
            if (ModelState.IsValid)
            {
